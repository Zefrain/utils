...
int GT_encryptionStr(const char *inputStr,
                     char       *outputStr,
                     const char *keyString);
int GT_decryptionStr(const char *inputStr,
                     char       *outputStr,
                     const char *keyString);
...
int fatal_enc(const char *inputStr, char **outputStr, char *keyString);
int fatal_dec(const char *inputStr, char **outputStr, char *keyString);
